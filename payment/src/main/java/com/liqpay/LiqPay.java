...
public class LiqPay implements LiqPayApi {
    ...
    public Map<String, Object> api(String path, Map<String, String> params) throws Exception {
        ...
        String resp = LiqPayRequest.post(LIQPAY_API_URL + path, data, getProxyLogin(), getProxyPassword(), getProxy());
        return MAPPER.readValue(resp, new TypeReference<HashMap<String, Object>>() {
        });
    }

    protected Map<String, String> generateData(Map<String, String> params) throws Exception {
        HashMap<String, String> apiData = new HashMap<>();
        String data = base64_encode(MAPPER.writeValueAsString(withBasicApiParams(params)));
    ...
    public String cnb_form(Map<String, String> params) {
        ...
        String data;
        try {
            data = base64_encode(MAPPER.writeValueAsString(withSandboxParam(withBasicApiParams(params))));
        } catch (Exception e) {
            throw new IllegalStateException("Can't serialize LiqPay checkout params", e);
        }
