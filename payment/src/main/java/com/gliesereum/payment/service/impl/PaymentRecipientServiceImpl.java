...
import com.gliesereum.payment.model.repository.jpa.PaymentRecipientRepository;
...
public class PaymentRecipientServiceImpl extends DefaultServiceImpl<PaymentRecipientDto, PaymentRecipientEntity> implements PaymentRecipientService {
    ...
    public PaymentRecipientDto getByObjectIdAndType(UUID objectId, PaymentObjectType type) {
        PaymentRecipientDto result = null;
        if (ObjectUtils.allNotNull(objectId, type)) {
