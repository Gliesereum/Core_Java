...
public class UserExceptionMessage {
    ...
    public static final ExceptionMessage DONT_FOUND_DEPENDENCY_USER_AND_BUSINESS = new ExceptionMessage(1016, 400, "Dnot found dependency user and business");
    ...
    public static final ExceptionMessage USER_DONT_HAVE_PERMISSION_TO_BUSINESS = new ExceptionMessage(1019, 400, "Current user don't have permission to action on business");
